...
public class GameResources {
    ...
    public static final String BG_IMG_PATH="textures/background.png";
    ...
    public static final String FULL_BLACKOUT_IMG_PATH="textures/blackout_full.png";
    public static final String BUTTON_BACKGROUND_SHORT_IMG_PATH="textures/button_background_short.png";
    public static final String BUTTON_BACKGROUND_LONG_IMG_PATH="textures/button_background_long.png";
    ...
    //Why don't I write in Russian? because the studio considers it a grammatical error.
}
